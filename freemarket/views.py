...
def sell_page(request):
    if (request.method == 'POST'):
        product_data = Product(name=request.POST["name"], genre=request.POST["genre"], explanation=request.POST["explanation"], condition=request.POST["condition"], price=request.POST["pricre"], shipping_cost=request.POST["shipping_cost"], picture_1=request.POST["picture_1"], picture_2=request.POST["picture_2"], picture_3=request.POST["picture_3"], picture_4=request.POST["picture_4"],)
        product_data.save()
